...
function addTask() {
  ...
  <>
    ...
    className='bg-(--cta) z-2 fixed bottom-8 left-1/2 -translate-x-1/2 w-md h-md rounded-full shadow-md shadow-gray-700 '>
      <motion.svg whileHover={{scale: 1.1}} animate={{rotate: addFormToggle ? 45 : 0}} className="w-md h-md cursor-pointer active:bg-(--cta-dark) active:rounded-full" viewBox="0 0 100 100">
